                ...
                <div className="container">
                  <div className="row g-4 gx-5 align-items-center">
                    <div className="col-lg-6">
                        ...
                        <Link className="btn-main mb10 mb-3 wow fadeInUp" data-wow-delay=".6s" to="/website-scanner"><span>Start Scan</span></Link>
                ...
                <div className="container">
                    <div className="row g-4">
                        ...
                        <div className="col-md-2">                            
                            <Link className="btn-main fx-slide btn-line" to="/website-scanner"><span>Start Scan</span></Link>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section>
                <div className="container">
                    <div className="row g-4 mb-2">
                        <div className="col-lg-12 text-center">
                            <div className="subtitle mb-3 wow fadeInUp">Latest News</div>
                            <h2 className="wow fadeInUp" data-wow-delay=".2s">Cyber Insights &amp; Updates</h2>
                            <p className="lead wow fadeInUp" data-wow-delay=".4s">Stay informed with the latest trends, strategies, and deep-dives into the ever-evolving world of enterprise cybersecurity.</p>
                        </div>
                    </div>
