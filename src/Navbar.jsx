...
const navLinks = [
  ...
  { label: 'Shodan Services', to: '#', children: [
    { label: 'Device Discovery', to: '/shodan-device-discovery' },
    { label: 'Vulnerability Detection', to: '/shodan-vulnerability-detection' },
    { label: 'Network Monitoring', to: '/shodan-network-monitoring' },
    { label: 'Internet Intelligence', to: '/shodan-internet-intelligence' },
  ]},
